...
class AttentionMap(nn.Module):
    ...
    def __init__(self, cfg, num_channels, pre_train_paths = None, modality=None):
        ...
        if pre_train_paths is not None:
            ...
            if modality == "CXR":
                if pre_train_path1 is not None and os.path.exists(pre_train_path1):
                    print(f"attention map pre_train_paths:{pre_train_path1}")
                ...
                if pre_train_path2 is not None and os.path.exists(pre_train_path2):
                    print(f"attention map pre_train_paths:{pre_train_path2}")
