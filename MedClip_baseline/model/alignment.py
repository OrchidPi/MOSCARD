...
from model.attention.cross_attention_new import CrossAttention 
...
class Alignment(nn.Module):
    ...
    def __init__(self, cfg, pretrained = False, pretrain_paths=None):
        super(Alignment, self).__init__()
        self.cfg = cfg
        self.backbone = create_twomodal_densenet(cfg, pre_train_paths=pretrain_paths)
        self.global_pool_CXR = GlobalPool(cfg, pre_train_paths=pretrain_paths, modality="CXR")
        self.global_pool_ECG = GlobalPool(cfg, pre_train_paths=pretrain_paths, modality="ECG")
        self.expand = 1
        ...
        self._init_attention_map_CXR(pre_train_paths=pretrain_paths, modality="CXR")
        self._init_attention_map_ECG(pre_train_paths=pretrain_paths, modality="ECG")
    ...
    def forward(self, x1, x2):
        ...
        return (causal_logits, main_logits, conf_CXR_logits, conf_ECG_logits, feat_ECG_, feat_CXR_, feat_map1_attention_, feat_map2_attention_, loss)
