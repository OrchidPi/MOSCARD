...
class DenseNetDecoder(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(12, 6), norm_type='Unknown', num_init_features=512, bn_size=4, drop_rate=0, num_classes=1):
        ...
        # Final upsampling to reach (N, 1, 512, 512)
        self.final_upsample = nn.Sequential(
            nn.ConvTranspose2d(num_features, 64, kernel_size=2, stride=2),
