...
PYTHONPATH=.:$PYTHONPATH python /media/Datacenter_storage/jialu/003/MACE/Multimodal_MACE/bin/train_MCAT_causal.py /media/Datacenter_storage/jialu/003/MACE/Multimodal_MACE/config/Mayo.json /media/Datacenter_storage/jialu/003/MACE/logdir_MACE_final/MCAT_vit_losssave_causalconf --num_workers 8 --device_ids "3" --pre_train_backbone /media/Datacenter_storage/jialu/003/logdir/logdir-pretrain_vit_conf_ecg/best2.ckpt /media/Datacenter_storage/jialu/003/logdir/logdir_pretrain_vit_conf_cxr/best3.ckpt --model "causal" --logtofile True
